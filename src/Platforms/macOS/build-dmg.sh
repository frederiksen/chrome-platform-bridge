...
cp ../../NativeMessagingHost/bin/Release/netcoreapp2.1/osx-x64/publish/* ROOT/Library/chrome-platform-bridge-demo
chmod +x ROOT/Library/chrome-platform-bridge-demo/NativeMessagingHost
# create the pkg then sign it then put it in a dmg
pkgbuild --root ROOT --identifier com.myfunkyapps.chromeplatformbridge --version 0.3 chrome-platform-bridge.unsigned.pkg
